...
osgi-filestore is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/osgi-filestore/issues/new/choose[issue form].
